  ...
  <div class="col-md-6 login-image"></div> 
    <div class="col-md-6 d-flex align-items-center justify-content-center"> 
      <form class="w-75" (ngSubmit)="onSubmit()">
          <h2 class="text-center mb-1 fw-light">Login As <span class="fw-bold text-success">ADMIN</span></h2>
          ...
          <button type="submit" class="btn btn-success btn-block my-3 w-100" routerLink="/admin/dashboard">Login</button>
          <div class="text-center mt-3">
              <a href="#" class="text-decoration-none text-secondary">Forgot password?</a>
          </div>
          <div class="text-center mt-2">
              <p class="text-body">Don't have an account? <a href="#" class="text-decoration-none text-secondary" routerLink="/register/admin">Register here</a></p>
          </div>
      </form>
  </div>
</div>
